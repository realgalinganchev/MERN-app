...
export default function About() {
    return <Fragment>
        <div id="containerPrivacy">
            ...
            <p>Nightlifesofia ("us", "we", or "our") operates the <a
                href="https://nightlifesofia.com/">https://nightlifesofia.com</a> website (hereinafter referred to as
            the
        "Service").</p>
        ...
        Service and the choices you have associated with that data.</p>
            ...
            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and
                ...
                in
                this
                Privacy Policy have the same meanings as in our , accessible from
        <a href="#/terms-and-conditions">Terms and Conditions</a>
            ...
            <ul>
                <li>
                    ...
                    <p>Service is the <a href="https://nightlifesofia.com/">https://nightlifesofia.com</a> website operated
                by nightlifesofia</p>
                </li>
                <li>
            ...
            <p>While using our Service, we may ask you to provide us with certain personally identifiable information that
                can
                be
                used to contact or identify you ("Personal Data"). Personally identifiable information may include, but is
                not
        limited to:</p>
        ...
        not accept cookies, you may not be able to use some portions of our Service.</p>
            ...
            <p>nightlifesofia uses the collected data for various purposes:</p>
            <ul>
        ...
        those from your jurisdiction.</p>
            <p>If you are located outside Bulgaria and choose to provide information to us, please note that we transfer the
                data,
        including Personal Data, to Bulgaria and process it there.</p>
            <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
                to
                that
        transfer.</p>
            <p>nightlifesofia will take all steps reasonably necessary to ensure that your data is treated securely and in
        ...
        information.</p>
            ...
            <p>nightlifesofia may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of nightlifesofia</li>
                <li>To prevent or investigate possible wrongdoing in connection with the Service</li>
                <li>To protect the personal safety of users of the Service or the public</li>
                <li>To protect against legal liability</li>
            </ul>

            <p>As an European citizen, under GDPR, you have certain individual rights. For more information please visit: 
        <a
                    href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en"> the
             European Commission website</a>.</p>
        ...
        party sites or services.</p>
            ...
            <p>We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a
                parent
                or guardian and you are aware that your Child has provided us with Personal Data, please contact us. If we
                become
                aware that we have collected Personal Data from children without verification of parental consent, we take
                steps
                to
        ...
        <ul>
            <li>
                <a href="mailto: info@nightlifesofia.com">info@nightlifesofia.com</a>
            </li>
