...
export default function About() {
    return <Fragment>
        <div id="containerPrivacy">
            <h2 align="center"><strong>Terms and Conditions</strong></h2>

            <p>Welcome to nightlifesofia!</p>

            <p>These terms and conditions outline the rules and regulations for the use of nightlifesofia's Website, located at
            www.nightlifesofia.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use nightlifesofia
                if
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
                ...
                payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for
                the
                express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services, in
                accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology or other words
                in
            ...
            <p>We employ the use of cookies. By accessing nightlifesofia, you agreed to use cookies in agreement with the
            nightlifesofia's <a href="#/privacy-policy">Privacy policy</a>.</p>
            ...
            <p>Unless otherwise stated, nightlifesofia and/or its licensors own the intellectual property rights for all
                material on
                nightlifesofia. All intellectual property rights are reserved. You may access this from nightlifesofia for your
                own
            personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from nightlifesofia</li>
                <li>Sell, rent or sub-license material from nightlifesofia</li>
                <li>Reproduce, duplicate or copy material from nightlifesofia</li>
                <li>Redistribute content from nightlifesofia</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                areas
                of the website. nightlifesofia does not filter, edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of nightlifesofia,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
                applicable laws, nightlifesofia shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.</p>

            <p>nightlifesofia reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant nightlifesofia a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                ...
                records
                with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of nightlifesofia;
                and
            ...
            must inform us by sending an e-mail to <a href="mailto: abc@example.com">info@nightlifesofia.com</a>. Please
                ...
                and a
            list of the URLs on our site to which you would like to link.</p>
            ...
            <p>No use of nightlifesofia's logo or other artwork will be allowed for linking absent a trademark license
                agreement.
        </p>
